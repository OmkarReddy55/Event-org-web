...
<body>
  ...
  <form class="login-form" id="admin_login">
    <h1>Admin Login</h1>
    <input autocomplete="off" type="hidden" name="action"  value="admin_login">
    <div class="form-input-material">
      <input type="text" name="admin_email" id="admin_email" value="" placeholder=" " autocomplete="off" class="form-control-material" required />
      <label for="username">Email Address</label>
    </div>
    <div class="form-input-material">
      <input type="password" name="admin_password" id="admin_password" value="" placeholder=" " autocomplete="off" class="form-control-material" required />
      <label for="password">Password</label>
    </div>
    <button type="button" class="btn btn-primary btn-ghost" id="bt_admin_login">Login</button>
