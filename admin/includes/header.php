    ...
    <div class="main-content-wrapper d-flex clearfix">
            ...
            <nav class="amado-nav" style="width: 126px;"  >
                ...
                <ul>
                    ...
                    <li><a href="vendor.php" title="Manage Vendors"><i class="fa fa-cogs"></i><span>Manage Vendors</span></a></li>
                    <li><a href="content.php" title="Manage Categories"><i class="fa fa-shopping-basket"></i><span>Manage Categories</span></a></li>
                    <li><a href="pro.php" title="Profile"><i class="fa fa-user"></i><span>Profile</span></a></li>
                
                    <li><div class="amado-btn-group">
                    <?php
                    if(isset($_SESSION["admin_logged_in"]) && $_SESSION["admin_logged_in"] == true){ 
                        echo '<a href="../loginstype.php" ><i class="fa fa-sign-out"></i><span>Logout</span></a>';
                    } else {
