...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    updateVendorProfile($conn, $_SESSION["vendor_id"], $_POST["new_first_name"], $_POST["new_email"]);
...
<body>
  ...
  <div class="frame flex">
    <div class="center" style="margin-left: 31px; height: 325px;">
      ...
      <div class="profile">
        ...
        <form action="" method="post" style="margin-left: 35px;">
                    <div class="name">
                        <input type="text" name="new_first_name"  style="width: 108%;
    height: 35px;
    margin-left: 66px;border-style: hidden;" value="<?php echo $Profile["first_name"]; ?>"
    ...
    margin-left: 47px;border-style: hidden;" value="<?php echo $Profile["email"]; ?>"
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="30px" viewBox="5 0 80 60" style="margin-left: 63px;">
                            <path id="wave" fill="none" stroke="#262626" stroke-width="2" stroke-linecap="round"></path>
                        </svg>
                    </div>

                                  <div class="actions" style="margin-left: 45px;">
                  <button type="submit" class="btn hvr-underline-from-center" style="margin-right: 14px;">Update</button>
                  <a href="profile.php" class="btn hvr-underline-from-center">Reset Password</a>
              </div>
                </form>
        </div>
      </div>
